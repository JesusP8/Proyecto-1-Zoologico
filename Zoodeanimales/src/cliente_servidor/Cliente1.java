...
public class Cliente1 extends JFrame implements Observer,ActionListener {
	private JFrame view;
	...
	private void componentes() {
        ...
        view.setTitle("Cliente 1(chat)");
        view.setLayout(null);
        view.setVisible(true);
        view.setBounds(-5, 10, 450, 450);
	...
	public void actionPerformed(ActionEvent e) {
		String mensaje = "Maracaibo: " + this.textField.getText() +"\n";
